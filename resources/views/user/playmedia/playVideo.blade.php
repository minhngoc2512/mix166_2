                    ...
                    <div class="video-info clearfix">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-6">
                                <div class="video-o">
                                    <span  class="views">{{$data[0]->view_count}}</span>
                                    <ul class="list-inline">
                                        <li>
                                            <a ><i onclick="userFavorite({{$data[0]->file_id}})" class="glyph-icon flaticon-favorite"></i><span
                                                        id="like-count"> {{$favorite[0]->favorite}}</span></a>
                                        </li>
                                        <li>
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="play-music-singer">
                                <a class="link-img" href="/dj/don-diablo-2000573.html">

                                    <img class="bgi" src="http://st.mix166.com/html/images/spacer.gif"
                                         style="background-image: url(http://st.cdn.mix166.com/images/edm_artists/2016/04/01/1459501063-h3jelbns.jpeg?w=250&amp;mode=scale);"
                                         alt="">
                                </a>
                        ...
                        <div class="col-sm-9">
                            <div class="comments">
                                ...
                                <div class="fb-comments" data-href="https://developers.facebook.com/docs/plugins/comments#mix166-laravel-{!! $data[0]->file_id !!}" data-width="500" data-numposts="5"></div>
                        ...
                        <div class="list-video-other">
                            ...
                            <div class="media">
                                <div class="media-left">
                                    <a href="{{url('file',['id'=>$value->file_id])}}" class="link-img"><img
                                                class="bgi" src="http://st.mix166.com/html/images/spacer.gif"
                                                style="background-image: url({{asset($value->video_image)}});"
                                                alt=""></a>
                                </div>
                                <div class="media-body">
                                    <h2 class="name"><a href="{{url('file',['id'=>$value->file_id])}}">{{$value->file_name}}</a></h2>
                                    <h3 class="singer">by
                                        <a href="{{url('file',['id'=>$value->file_id])}}">{{$value->file_name}}</a>
                                    </h3>
                                    <span class="views">776 view</span>
                                </div>
                            </div>
                                @endforeach
